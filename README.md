...
<details>
  ...
  * Data para entrega no prazo regular: `28/11/2022 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-019-c-project-algorithms.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-019-c-project-algorithms`
  ...
  - Crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-019-c-project-algorithms`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-019-c-project-algorithms`

  7. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-019-c-project-algorithms/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-019-c-project-algorithms/pulls) e confira que o seu _Pull Request_ está criado
